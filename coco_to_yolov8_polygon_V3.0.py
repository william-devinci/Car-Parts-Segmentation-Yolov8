...
if __name__ == "__main__":
    base_input_path = "Car-Parts-Segmentation-Experimentation/"
    base_output_path = "Car-Parts-Segmentation-Experimentation/yolo_dataset/"

    
    # Processing validation dataset (if needed)
    convert_to_yolo(
        input_images_path=os.path.join(base_input_path, "validset/validset_JPEGImages"),
        input_json_path=os.path.join(base_input_path, "validset/validset_annotations_min_area_1000_clean.json"),
    ...
    convert_to_yolo(
        input_images_path=os.path.join(base_input_path, "trainingset/trainingset_JPEGImages"),
        input_json_path=os.path.join(base_input_path, "trainingset/trainingset_annotations_min_area_1000_clean.json"),
    ...
    convert_to_yolo(
        input_images_path=os.path.join(base_input_path, "testset/testset_JPEGImages"),
        input_json_path=os.path.join(base_input_path, "testset/testset_annotations_min_area_1000.json"),
    ...
    create_yaml(
        ...
        train_path= os.path.join(base_input_path, "trainingset/trainingset_JPEGImages"), #"EM-Platelet/train/images",
        val_path= os.path.join(base_input_path, "validset/validset_JPEGImages"), #"EM-Platelet/valid/images",
        test_path=os.path.join(base_input_path, "testset_JPEGImages")  #  '../test/images' or None if not applicable
    )
